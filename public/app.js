...
el.soundTest && el.soundTest.addEventListener('click', async()=>{ primeAudio(); const ok = await playBeep(); if (navigator.vibrate) navigator.vibrate(160); if (!ok) alert('このブラウザでは音を鳴らせませんでした。音量・マナーモードを確認してください。'); });
